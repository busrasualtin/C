...
void howToPlay(){
	...
	printf("\nayni satirda ve ayný sutunda tekrar etmemeli.\n");
...
int main(){
	...
	// Sudoku da 1-9 arasi sayilar olacak.Onlari dizinin 1.satirina yerleþtirelim.
	// 2.satirda ise sayinin o anki sudoku sutununda kullanýlýp kullanýlmadýgý degerini tutacak
	...
	while( j != N ){ // counter of columns 
		...
		while( i != N ){	
			// Eðer 100 kerede sayi bulunmamissa ters giden bir seyler var.O sutuna sayilari bastan yerlestirecez.		
			if( times > 100 ){
				i = 100;
				break;
			}
			...
			// Sayinin yerlestirilemediði basarisiz olunan durum sayisi
			times++;
			...
			// Secilen sayi o anki 9 lu hucrenin icinde var mý?
	...
	// Kullaniciya gosterecegimiz sudoku da bazý elemanlari onceden yerlestirmemiz lazým
